...
#define BIT_COE_IPHDR_DROP		MK_BITS(4, 1)
#define BIT_COE_PAYLOAD_DROP		MK_BITS(5, 1)
#define BIT_COE_IPV6_UDP_ZERO_DROP	MK_BITS(6, 1)
...
#define HIGMAC_DUAL_MAC_CRF_ACK_TH      (IO_ADDRESS(CONFIG_HIGMAC_IOBASE + \
							0x3004))

/* AXI burst and outstanding config */
#define BURST_OUTSTANDING_REG		(IO_ADDRESS(CONFIG_HIGMAC_IOBASE + \
							0x3014))
#define BURST4_OUTSTANDING1				0x81ff

/* macif CRG */
#define HIGMAC_MAC_IF_IOBASE	(IO_ADDRESS(REG_BASE_CRG + REG_ETH_MAC_IF))
/* gmac CRG */
#define HIGMAC_CRG_IOBASE	(IO_ADDRESS(REG_BASE_CRG + REG_ETH_CRG))
