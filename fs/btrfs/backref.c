...
#ifdef CONFIG_SYNO_BTRFS_FAST_QGROUP
	/*
	 * This mode will find if specific EXTENT_ITEM is pointed by an inode of
	 * designated subvolume. It will return earlier if such contidion is found.
	 */
	BTRFS_BACKREF_FIND_ROOT_INO,
#endif /* CONFIG_SYNO_BTRFS_FAST_QGROUP */
#ifdef MY_ABC_HERE
	/*
...
/*
 * Here's how we work, we only calculate the extent data from lowest subvolume id,
 * and lowest inode number in that subvolume, and also the lowest file offset.
 */
